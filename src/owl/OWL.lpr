...
(define-project :name :OWL
  :modules (list (make-instance 'module :name "owlerror")
  ...
  :runtime-modules (list :cg-dde-utils :cg.base :cg.bitmap-pane :cg.bitmap-pane.clipboard
                         ...
                         :cg.hotspot :cg.icon :cg.icon-pixmap :cg.item-list
                         :cg.keyboard-shortcuts :cg.lettered-menu :cg.lisp-edit-pane
                         ...
                         :cg.multi-picture-button.tooltip :cg.os-widget :cg.os-window
                         ...
                         :cg.scroll-bar-mixin :cg.selected-object :cg.shortcut-menu
