...
(excl:defsystem :rdfs (:pretty-name "RDFS subsystem of SWCLOS"
  ...
  (:module :rdfboot0     "RDFboot0"     (:load-before-compile :rdf :slotdef))
  (:module :rdfboot1     "RDFboot1"     (:load-before-compile :rdf :rdfboot0))
  (:module :rdfboot      "RDFboot"      (:load-before-compile :rdf :rdfboot1))
  ...
  (:module :gxtype0      "GxType0"      (:load-before-compile :rdf :slotdef :rdfboot))
  (:module :gxtype       "GxType"       (:load-before-compile :rdf :gxtype0))
